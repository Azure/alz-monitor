...
module ErpExpressRouteTxLightLevelLowAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-erprTxlhl-policyDefinitions'
    params: {
        name: 'Deploy_ERP_ExpressRoutTxLightLevellow_Alert'
        displayName: '[DINE] Deploy ER Direct ExpressRoute TxLightLevel Low Alert'
        description: 'DINE policy to audit/deploy ER Direct TxLightLevel Low Alert'
