...
module ALBDataPathAvailabilityAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-albdatapathavailability-policyDefinitions'
    params: {
        name: 'Deploy_ALB_DataPathAvailability_Alert'
        displayName: '[DINE] Deploy ALB Data Path Availability Alert'
        description: 'DINE policy to audit/deploy Azure Load Balancer Data Path Availability Alert'
