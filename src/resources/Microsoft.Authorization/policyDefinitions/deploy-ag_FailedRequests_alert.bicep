...
module FailedRequestsAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-AGFailedRequests-policyDefinitions'
    params: {
        name: 'Deploy_AG_FailedRequests_Alert'
        displayName: '[DINE] Deploy AG FailedRequests Alert'
        description: 'DINE policy to audit/deploy Azure Application Gateway FailedRequests Alert'
