...
module BackendLastByteResponseTime '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-AGBackendLastByteResponseTime-policyDefinitions'
    params: {
        name: 'Deploy_AG_BackendLastByteResponseTime_Alert'
        displayName: '[DINE] Deploy AG BackendLastByteResponseTime Alert'
        description: 'DINE policy to audit/deploy Azure Application Gateway BackendLastByteResponseTime Alert'
