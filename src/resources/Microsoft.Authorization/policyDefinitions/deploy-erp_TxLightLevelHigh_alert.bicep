...
module ErpExpressRouteTxLightLevelHighAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-erprTxlh-policyDefinitions'
    params: {
        name: 'Deploy_ERP_ExpressRoutTxLightLevell_Alert'
        displayName: '[DINE] Deploy ER Direct ExpressRoute TxLightLevel High Alert'
        description: 'DINE policy to audit/deploy ER Direct TxLightLevel High Alert'
