...
param parThreshold string = '900'

param parMonitorDisable string = 'MonitorDisable'

module ALBUsedSNATPortsAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-albusedsnatports-policyDefinitions'
    params: {
        name: 'Deploy_ALB_UsedSNATPorts_Alert'
        displayName: '[DINE] Deploy ALB Used SNAT Ports Alert'
        description: 'DINE policy to audit/deploy Azure Load Balancer Used SNAT Ports Alert'
