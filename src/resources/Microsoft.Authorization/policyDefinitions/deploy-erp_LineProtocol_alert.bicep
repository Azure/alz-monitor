...
param parThreshold string = '0.9'

param parMonitorDisable string = 'MonitorDisable' 

module ErpExpressRouteLineProtocoltAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-erpergbout-policyDefinitions'
    params: {
        name: 'Deploy_ERP_ExpressRoutLineProtocol_Alert'
        displayName: '[DINE] Deploy ER Direct ExpressRoute LineProtocol Alert'
        description: 'DINE policy to audit/deploy ER Direct LineProtocol Alert'
