...
param parThreshold string = '20'

param parMonitorDisable string = 'MonitorDisable'

module FirewallHealthAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    name: '${uniqueString(deployment().name)}-AGUnhealthyHostCount-policyDefinitions'
    params: {
        name: 'Deploy_AG_UnhealthyHostCount_Alert'
        displayName: '[DINE] Deploy AG Unhealthy Host Count Alert'
        description: 'DINE policy to audit/deploy Azure Application Gateway Unhealthy Host Count Alert'
