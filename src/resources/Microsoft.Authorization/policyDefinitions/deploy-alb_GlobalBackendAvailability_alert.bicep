...
module FirewallHealthAlert '../../arm/Microsoft.Authorization/policyDefinitions/managementGroup/deploy.bicep' = {
    ...
    params: {
        ...
        displayName: '[DINE] Deploy ALB Global Backend Availability Alert'
        description: 'DINE policy to audit/deploy Azure Load Balancer Global Backend Availability Alert'
