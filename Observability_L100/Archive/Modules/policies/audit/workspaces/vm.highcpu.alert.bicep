    ...
    policyRule: {
      if: {
        allOf: [
          ...
          {
            field:'Microsoft.Insights/metricAlerts/criteria.odata.type'
            equals: 'Microsoft.Azure.Monitor.MultipleResourceMultipleMetricCriteria'
          }
          {
          ...
          }
          {
            ...
            equals: 'Average_% Processor Time'
          }
        ]
      }
      then: {
